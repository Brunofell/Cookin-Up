...
import { itensDeListaUmEstaoEmListaDois } from '@/operacoes/Listas'
export default {
    props:{
  ...
  async created() {
    ...
    this.receitasEncontradas = receitas.filter((receita)=>{
        const possoFazerReceita = itensDeListaUmEstaoEmListaDois(receita.ingredientes, this.ingredientes)
